...
/// Reset to 0 on successful completion or engagement reset.
 ...
 double? get uploadProgress; int? get uploadBytesTransferred; int? get uploadTotalBytes;/// True while the startEngagement CF is in-flight after an optimistic
/// phase transition. Content is shown immediately; submission is held
/// until this is false and [currentEngagement] is populated.
 bool get isCreatingEngagement;/// Whether the completed engagement is pending admin review
...
@useResult
$Res call({
 EarnStatus status, List<EarnThread> threads, EarnThread? selectedThread, EarnStatus opportunitiesStatus, String? opportunitiesThreadId, List<EarnOpportunity> opportunities, EarnOpportunity? selectedOpportunity, Engagement? currentEngagement, EngagementPhase engagementPhase, List<Engagement> history, bool isLoadingHistory, bool hasMoreHistory, DateTime? lastHistoryTimestamp, String? errorMessage, int totalAvailableOpportunities, int dailyCompletions, int dailyEarnCap, bool dailyLimitReached, bool isAdLoading, bool isAdReady, String? adTransactionId, String? adResponseId, int adLoadAttempt, int adRetryRound, int adShowFailureCount, double? uploadProgress, int? uploadBytesTransferred, int? uploadTotalBytes, bool isCreatingEngagement, bool isPendingReview, String? rewardItemId, String? rewardCampaignName, String? rewardType
});
...
as int?,isCreatingEngagement: null == isCreatingEngagement ? _self.isCreatingEngagement : isCreatingEngagement // ignore: cast_nullable_to_non_nullable
as bool,isPendingReview: null == isPendingReview ? _self.isPendingReview : isPendingReview // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( EarnStatus status,  List<EarnThread> threads,  EarnThread? selectedThread,  EarnStatus opportunitiesStatus,  String? opportunitiesThreadId,  List<EarnOpportunity> opportunities,  EarnOpportunity? selectedOpportunity,  Engagement? currentEngagement,  EngagementPhase engagementPhase,  List<Engagement> history,  bool isLoadingHistory,  bool hasMoreHistory,  DateTime? lastHistoryTimestamp,  String? errorMessage,  int totalAvailableOpportunities,  int dailyCompletions,  int dailyEarnCap,  bool dailyLimitReached,  bool isAdLoading,  bool isAdReady,  String? adTransactionId,  String? adResponseId,  int adLoadAttempt,  int adRetryRound,  int adShowFailureCount,  double? uploadProgress,  int? uploadBytesTransferred,  int? uploadTotalBytes,  bool isCreatingEngagement,  bool isPendingReview,  String? rewardItemId,  String? rewardCampaignName,  String? rewardType)  $default,) {final _that = this;
switch (_that) {
case _EarnState():
return $default(_that.status,_that.threads,_that.selectedThread,_that.opportunitiesStatus,_that.opportunitiesThreadId,_that.opportunities,_that.selectedOpportunity,_that.currentEngagement,_that.engagementPhase,_that.history,_that.isLoadingHistory,_that.hasMoreHistory,_that.lastHistoryTimestamp,_that.errorMessage,_that.totalAvailableOpportunities,_that.dailyCompletions,_that.dailyEarnCap,_that.dailyLimitReached,_that.isAdLoading,_that.isAdReady,_that.adTransactionId,_that.adResponseId,_that.adLoadAttempt,_that.adRetryRound,_that.adShowFailureCount,_that.uploadProgress,_that.uploadBytesTransferred,_that.uploadTotalBytes,_that.isCreatingEngagement,_that.isPendingReview,_that.rewardItemId,_that.rewardCampaignName,_that.rewardType);case _:
  throw StateError('Unexpected subclass');
...
/// phase transition. Content is shown immediately; submission is held
/// until this is false and [currentEngagement] is populated.
@override@JsonKey() final  bool isCreatingEngagement;
