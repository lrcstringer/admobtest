...
return createListing(_that.title,_that.description,_that.category,_that.subCategory,_that.priceTokens,_that.imageUrls,_that.location,_that.deliveryMethod,_that.deliveryFee,_that.serviceAreaType,_that.locationData);case _ClearMessages() when clearMessages != null:
return clearMessages();case _UpdateListing() when updateListing != null:
return updateListing(_that.listingId,_that.title,_that.description,_that.category,_that.priceTokens,_that.imageUrls,_that.location,_that.deliveryMethod,_that.deliveryFee,_that.serviceAreaType,_that.locationData);case _ToggleListingStatus() when toggleListingStatus != null:
...
return createListing(_that.title,_that.description,_that.category,_that.subCategory,_that.priceTokens,_that.imageUrls,_that.location,_that.deliveryMethod,_that.deliveryFee,_that.serviceAreaType,_that.locationData);case _ClearMessages():
return clearMessages();case _UpdateListing():
return updateListing(_that.listingId,_that.title,_that.description,_that.category,_that.priceTokens,_that.imageUrls,_that.location,_that.deliveryMethod,_that.deliveryFee,_that.serviceAreaType,_that.locationData);case _ToggleListingStatus():
...
class _CreateListing implements MarketplaceEvent {
  const _CreateListing({required this.title, required this.description, required this.category, this.subCategory, required this.priceTokens, required final  List<String> imageUrls, this.location, this.deliveryMethod, this.deliveryFee, this.serviceAreaType, final  Map<String, dynamic>? locationData}): _imageUrls = imageUrls,_locationData = locationData;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CreateListing&&(identical(other.title, title) || other.title == title)&&(identical(other.description, description) || other.description == description)&&(identical(other.category, category) || other.category == category)&&(identical(other.subCategory, subCategory) || other.subCategory == subCategory)&&(identical(other.priceTokens, priceTokens) || other.priceTokens == priceTokens)&&const DeepCollectionEquality().equals(other._imageUrls, _imageUrls)&&(identical(other.location, location) || other.location == location)&&(identical(other.deliveryMethod, deliveryMethod) || other.deliveryMethod == deliveryMethod)&&(identical(other.deliveryFee, deliveryFee) || other.deliveryFee == deliveryFee)&&(identical(other.serviceAreaType, serviceAreaType) || other.serviceAreaType == serviceAreaType)&&const DeepCollectionEquality().equals(other._locationData, _locationData));
}


@override
int get hashCode => Object.hash(runtimeType,title,description,category,subCategory,priceTokens,const DeepCollectionEquality().hash(_imageUrls),location,deliveryMethod,deliveryFee,serviceAreaType,const DeepCollectionEquality().hash(_locationData));

@override
String toString() {
  return 'MarketplaceEvent.createListing(title: $title, description: $description, category: $category, subCategory: $subCategory, priceTokens: $priceTokens, imageUrls: $imageUrls, location: $location, deliveryMethod: $deliveryMethod, deliveryFee: $deliveryFee, serviceAreaType: $serviceAreaType, locationData: $locationData)';
}
...
@useResult
$Res call({
 String title, String description, String category, String? subCategory, int priceTokens, List<String> imageUrls, String? location, String? deliveryMethod, int? deliveryFee, String? serviceAreaType, Map<String, dynamic>? locationData
});
...
/// Create a copy of MarketplaceEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? title = null,Object? description = null,Object? category = null,Object? subCategory = freezed,Object? priceTokens = null,Object? imageUrls = null,Object? location = freezed,Object? deliveryMethod = freezed,Object? deliveryFee = freezed,Object? serviceAreaType = freezed,Object? locationData = freezed,}) {
...
as String?,deliveryMethod: freezed == deliveryMethod ? _self.deliveryMethod : deliveryMethod // ignore: cast_nullable_to_non_nullable
as String?,deliveryFee: freezed == deliveryFee ? _self.deliveryFee : deliveryFee // ignore: cast_nullable_to_non_nullable
as int?,serviceAreaType: freezed == serviceAreaType ? _self.serviceAreaType : serviceAreaType // ignore: cast_nullable_to_non_nullable
...
class _UpdateListing implements MarketplaceEvent {
  const _UpdateListing({required this.listingId, this.title, this.description, this.category, this.priceTokens, final  List<String>? imageUrls, this.location, this.deliveryMethod, this.deliveryFee, this.serviceAreaType, final  Map<String, dynamic>? locationData}): _imageUrls = imageUrls,_locationData = locationData;
...
@override
int get hashCode => Object.hash(runtimeType,listingId,title,description,category,priceTokens,const DeepCollectionEquality().hash(_imageUrls),location,deliveryMethod,deliveryFee,serviceAreaType,const DeepCollectionEquality().hash(_locationData));

@override
String toString() {
  return 'MarketplaceEvent.updateListing(listingId: $listingId, title: $title, description: $description, category: $category, priceTokens: $priceTokens, imageUrls: $imageUrls, location: $location, deliveryMethod: $deliveryMethod, deliveryFee: $deliveryFee, serviceAreaType: $serviceAreaType, locationData: $locationData)';
}
...
@useResult
$Res call({
 String listingId, String? title, String? description, String? category, int? priceTokens, List<String>? imageUrls, String? location, String? deliveryMethod, int? deliveryFee, String? serviceAreaType, Map<String, dynamic>? locationData
});
...
/// Create a copy of MarketplaceEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? listingId = null,Object? title = freezed,Object? description = freezed,Object? category = freezed,Object? priceTokens = freezed,Object? imageUrls = freezed,Object? location = freezed,Object? deliveryMethod = freezed,Object? deliveryFee = freezed,Object? serviceAreaType = freezed,Object? locationData = freezed,}) {
