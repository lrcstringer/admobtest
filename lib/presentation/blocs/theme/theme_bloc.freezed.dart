...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _LoadSavedTheme value)?  loadSavedTheme,TResult Function( _SetThemeMode value)?  setThemeMode,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _LoadSavedTheme() when loadSavedTheme != null:
return loadSavedTheme(_that);case _SetThemeMode() when setThemeMode != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _LoadSavedTheme value)  loadSavedTheme,required TResult Function( _SetThemeMode value)  setThemeMode,}){
final _that = this;
switch (_that) {
case _LoadSavedTheme():
return loadSavedTheme(_that);case _SetThemeMode():
return setThemeMode(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _LoadSavedTheme value)?  loadSavedTheme,TResult? Function( _SetThemeMode value)?  setThemeMode,}){
final _that = this;
switch (_that) {
case _LoadSavedTheme() when loadSavedTheme != null:
return loadSavedTheme(_that);case _SetThemeMode() when setThemeMode != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loadSavedTheme,TResult Function( ThemeMode mode)?  setThemeMode,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoadSavedTheme() when loadSavedTheme != null:
return loadSavedTheme();case _SetThemeMode() when setThemeMode != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loadSavedTheme,required TResult Function( ThemeMode mode)  setThemeMode,}) {final _that = this;
switch (_that) {
case _LoadSavedTheme():
return loadSavedTheme();case _SetThemeMode():
return setThemeMode(_that.mode);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loadSavedTheme,TResult? Function( ThemeMode mode)?  setThemeMode,}) {final _that = this;
switch (_that) {
case _LoadSavedTheme() when loadSavedTheme != null:
return loadSavedTheme();case _SetThemeMode() when setThemeMode != null:
return setThemeMode(_that.mode);case _:
...
class _LoadSavedTheme implements ThemeEvent {
  const _LoadSavedTheme();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LoadSavedTheme);
}
...
@override
String toString() {
  return 'ThemeEvent.loadSavedTheme()';
}
...
class _SetThemeMode implements ThemeEvent {
...
/// @nodoc
abstract mixin class _$SetThemeModeCopyWith<$Res> implements $ThemeEventCopyWith<$Res> {
