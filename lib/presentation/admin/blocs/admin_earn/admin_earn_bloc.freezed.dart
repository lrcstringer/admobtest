...
class __$$CreateThreadImplCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? tokenSourceSubAccountId = null,
      ...
      _$CreateThreadImpl(
        ...
        description: freezed == description
            ...
            : description // ignore: cast_nullable_to_non_nullable
                  as String?,
        tokenSourceSubAccountId: null == tokenSourceSubAccountId
...
class _$CreateThreadImpl implements _CreateThread {
  const _$CreateThreadImpl({
    ...
    required this.title,
    this.description,
    required this.tokenSourceSubAccountId,
  ...
  @override
  String toString() {
    return 'AdminEarnEvent.createThread(id: $id, clientId: $clientId, title: $title, description: $description, tokenSourceSubAccountId: $tokenSourceSubAccountId, tokenDestAccountTypeId: $tokenDestAccountTypeId, isPinned: $isPinned, isFeatured: $isFeatured, isActive: $isActive, activeFrom: $activeFrom, activeTo: $activeTo, targeting: $targeting)';
  }
...
abstract class _CreateThread implements AdminEarnEvent {
  const factory _CreateThread({
    ...
    final String? description,
    required final String tokenSourceSubAccountId,
    final String? tokenDestAccountTypeId,
    final bool isPinned,
    final bool isFeatured,
    final bool isActive,
