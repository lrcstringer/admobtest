...
part of 'marketplace_listing_model.dart';
...
/// @nodoc
abstract mixin class $MarketplaceListingModelCopyWith<$Res>  {
...
as DateTime?,providerCompletedOrders: null == providerCompletedOrders ? _self.providerCompletedOrders : providerCompletedOrders // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
/// Create a copy of MarketplaceListingModel
...
/// Adds pattern-matching-related methods to [MarketplaceListingModel].
extension MarketplaceListingModelPatterns on MarketplaceListingModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _MarketplaceListingModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _MarketplaceListingModel value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _MarketplaceListingModel value)?  $default,){
final _that = this;
switch (_that) {
case _MarketplaceListingModel() when $default != null:
return $default(_that);case _:
...
class _MarketplaceListingModel extends MarketplaceListingModel {
  const _MarketplaceListingModel({required this.id, required this.title, required this.description, required this.category, this.subCategory, required this.priceTokens, required this.priceZar, final  List<String> images = const [], this.thumbnailUrl, required this.providerId, required this.providerName, this.providerPhotoUrl, this.providerTrustScore, this.providerIsVerified, this.communityId, this.location, required this.status, this.viewCount = 0, this.reportCount = 0, this.expiresAt, required this.createdAt, this.locationData, this.serviceAreaType = ServiceAreaType.myLocationOnly, this.deliveryMethod = DeliveryMethod.collection, this.deliveryFee, this.geohash, this.favouriteCount = 0, this.renewalCount = 0, this.totalPausedDays = 0, this.pausedAt, this.providerCompletedOrders = 0}): _images = images,super._();
...
@override@JsonKey() final  int providerCompletedOrders;

/// Create a copy of MarketplaceListingModel
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$MarketplaceListingModelCopyWith<_MarketplaceListingModel> get copyWith => __$MarketplaceListingModelCopyWithImpl<_MarketplaceListingModel>(this, _$identity);
...
/// @nodoc
abstract mixin class _$MarketplaceListingModelCopyWith<$Res> implements $MarketplaceListingModelCopyWith<$Res> {
...
/// @nodoc
class __$MarketplaceListingModelCopyWithImpl<$Res>
    implements _$MarketplaceListingModelCopyWith<$Res> {
  __$MarketplaceListingModelCopyWithImpl(this._self, this._then);

  final _MarketplaceListingModel _self;
  final $Res Function(_MarketplaceListingModel) _then;
