...
@useResult
$Res call({
 String id, String subAccountId, String userId, String providerId, String providerName, String category, int tokenAmount, double zarAmount, String status, String productCode, String productName, String? recipientNumber, String? voucherCode, String? voucherPin, String? reference, String? failureReason, Map<String, dynamic>? metadata, DateTime createdAt, DateTime? processedAt, DateTime? completedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String subAccountId,  String userId,  String providerId,  String providerName,  String category,  int tokenAmount,  double zarAmount,  String status,  String productCode,  String productName,  String? recipientNumber,  String? voucherCode,  String? voucherPin,  String? reference,  String? failureReason,  Map<String, dynamic>? metadata,  DateTime createdAt,  DateTime? processedAt,  DateTime? completedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PurchaseModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String subAccountId,  String userId,  String providerId,  String providerName,  String category,  int tokenAmount,  double zarAmount,  String status,  String productCode,  String productName,  String? recipientNumber,  String? voucherCode,  String? voucherPin,  String? reference,  String? failureReason,  Map<String, dynamic>? metadata,  DateTime createdAt,  DateTime? processedAt,  DateTime? completedAt)  $default,) {final _that = this;
switch (_that) {
case _PurchaseModel():
return $default(_that.id,_that.subAccountId,_that.userId,_that.providerId,_that.providerName,_that.category,_that.tokenAmount,_that.zarAmount,_that.status,_that.productCode,_that.productName,_that.recipientNumber,_that.voucherCode,_that.voucherPin,_that.reference,_that.failureReason,_that.metadata,_that.createdAt,_that.processedAt,_that.completedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String subAccountId,  String userId,  String providerId,  String providerName,  String category,  int tokenAmount,  double zarAmount,  String status,  String productCode,  String productName,  String? recipientNumber,  String? voucherCode,  String? voucherPin,  String? reference,  String? failureReason,  Map<String, dynamic>? metadata,  DateTime createdAt,  DateTime? processedAt,  DateTime? completedAt)?  $default,) {final _that = this;
switch (_that) {
case _PurchaseModel() when $default != null:
return $default(_that.id,_that.subAccountId,_that.userId,_that.providerId,_that.providerName,_that.category,_that.tokenAmount,_that.zarAmount,_that.status,_that.productCode,_that.productName,_that.recipientNumber,_that.voucherCode,_that.voucherPin,_that.reference,_that.failureReason,_that.metadata,_that.createdAt,_that.processedAt,_that.completedAt);case _:
  return null;
