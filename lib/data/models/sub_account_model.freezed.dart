...
SubAccountModel _$SubAccountModelFromJson(Map<String, dynamic> json) {
  return _SubAccountModel.fromJson(json);
}
...
abstract class $SubAccountModelCopyWith<$Res> {
  factory $SubAccountModelCopyWith(
    SubAccountModel value,
    $Res Function(SubAccountModel) then,
...
abstract class _$$SubAccountModelImplCopyWith<$Res>
    implements $SubAccountModelCopyWith<$Res> {
  factory _$$SubAccountModelImplCopyWith(
    _$SubAccountModelImpl value,
...
class __$$SubAccountModelImplCopyWithImpl<$Res>
  ...
  __$$SubAccountModelImplCopyWithImpl(
    _$SubAccountModelImpl _value,
    $Res Function(_$SubAccountModelImpl) _then,
  ) : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$SubAccountModelImpl extends _SubAccountModel {
  ...
  Map<String, dynamic> toJson() {
    return _$$SubAccountModelImplToJson(this);
  }
}

abstract class _SubAccountModel extends SubAccountModel {
  ...
  factory _SubAccountModel.fromJson(Map<String, dynamic> json) =
      _$SubAccountModelImpl.fromJson;
