...
@useResult
$Res call({
 String id, String userId, String displayName, String? bio, String? photoUrl, String? communityId, String? servicesDescription, ProviderStatus status, double trustScore, int vouchCount, int completedOrders, bool isVerified, bool? isVerifiedOverride, List<String> customerIds, DateTime createdAt, List<String> categories, List<String>? subCategories, SellerLevel sellerLevel, double? avgResponseTimeHrs, int warningCount, int reportCount, double disputeRate, double cancellationRate, String? suspensionReason, String? suspensionTrigger, DateTime? suspendedAt, DateTime? bannedAt, LocationData? profileLocation, double ratingSum, Map<String, bool> contactPreferences, int maxActiveListings, DateTime? acceptedTermsAt, DateTime? deregistrationRequestedAt, DateTime? deregistrationEffectiveAt
});
...
as double,contactPreferences: null == contactPreferences ? _self.contactPreferences : contactPreferences // ignore: cast_nullable_to_non_nullable
...
as DateTime?,profileLocation: freezed == profileLocation ? _self.profileLocation : profileLocation // ignore: cast_nullable_to_non_nullable
as LocationData?,ratingSum: null == ratingSum ? _self.ratingSum : ratingSum // ignore: cast_nullable_to_non_nullable
as double,contactPreferences: null == contactPreferences ? _self._contactPreferences : contactPreferences // ignore: cast_nullable_to_non_nullable
as Map<String, bool>,maxActiveListings: null == maxActiveListings ? _self.maxActiveListings : maxActiveListings // ignore: cast_nullable_to_non_nullable
as int,acceptedTermsAt: freezed == acceptedTermsAt ? _self.acceptedTermsAt : acceptedTermsAt // ignore: cast_nullable_to_non_nullable
as DateTime?,deregistrationRequestedAt: freezed == deregistrationRequestedAt ? _self.deregistrationRequestedAt : deregistrationRequestedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,deregistrationEffectiveAt: freezed == deregistrationEffectiveAt ? _self.deregistrationEffectiveAt : deregistrationEffectiveAt // ignore: cast_nullable_to_non_nullable
