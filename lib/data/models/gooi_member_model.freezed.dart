...
@override
String toString() {
  return 'GooiMemberModel(id: $id, userId: $userId, displayName: $displayName, avatarUrl: $avatarUrl, position: $position, role: $role, status: $status, contributedCycles: $contributedCycles, missedCycles: $missedCycles, outstandingDebt: $outstandingDebt, autoContribute: $autoContribute, autoContributeSubAccountId: $autoContributeSubAccountId, preferredSubAccountId: $preferredSubAccountId, delegateTriggerTo: $delegateTriggerTo, delegationExpiresAt: $delegationExpiresAt, joinedAt: $joinedAt, invitedAt: $invitedAt, removedAt: $removedAt)';
}
