...
mixin _$RewardItemModel {
 ...
 String get id; String get campaignId; String? get campaignName; String? get clientName; String? get clientAvatarImage; String? get clientAvatarColor; String? get rewardType; String get status;// Only populated on detail fetch (decrypted server-side)
 String? get codeValue; DateTime? get allocatedAt; DateTime? get redeemedAt; DateTime? get expiresAt; String? get redemptionLocation; Map<String, dynamic> get campaignMetadata; Map<String, dynamic> get itemMetadata;
...
@useResult
$Res call({
 String id, String campaignId, String? campaignName, String? clientName, String? clientAvatarImage, String? clientAvatarColor, String? rewardType, String status, String? codeValue, DateTime? allocatedAt, DateTime? redeemedAt, DateTime? expiresAt, String? redemptionLocation, Map<String, dynamic> campaignMetadata, Map<String, dynamic> itemMetadata
});
...
class _RewardItemModel extends RewardItemModel {
  const _RewardItemModel({required this.id, required this.campaignId, this.campaignName, this.clientName, this.clientAvatarImage, this.clientAvatarColor, this.rewardType, required this.status, this.codeValue, this.allocatedAt, this.redeemedAt, this.expiresAt, this.redemptionLocation, final  Map<String, dynamic> campaignMetadata = const {}, final  Map<String, dynamic> itemMetadata = const {}}): _campaignMetadata = campaignMetadata,_itemMetadata = itemMetadata,super._();
