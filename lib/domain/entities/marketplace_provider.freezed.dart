...
@useResult
$Res call({
 String id, String userId, String displayName, String? bio, String? photoUrl, String? communityId, ProviderStatus status, double trustScore, int vouchCount, int completedOrders, bool isVerified, bool? isVerifiedOverride, List<String> customerIds, DateTime createdAt, List<String> categories, List<String>? subCategories, SellerLevel sellerLevel, double? avgResponseTimeHrs, int warningCount, int reportCount, double disputeRate, double cancellationRate, String? suspensionReason, String? suspensionTrigger, DateTime? suspendedAt, DateTime? bannedAt, LocationData? profileLocation, double ratingSum, String? servicesDescription, Map<String, bool> contactPreferences, int maxActiveListings, DateTime? acceptedTermsAt, DateTime? deregistrationRequestedAt, DateTime? deregistrationEffectiveAt
});
...
as double,servicesDescription: freezed == servicesDescription ? _self.servicesDescription : servicesDescription // ignore: cast_nullable_to_non_nullable
as String?,contactPreferences: null == contactPreferences ? _self.contactPreferences : contactPreferences // ignore: cast_nullable_to_non_nullable
as Map<String, bool>,maxActiveListings: null == maxActiveListings ? _self.maxActiveListings : maxActiveListings // ignore: cast_nullable_to_non_nullable
as int,acceptedTermsAt: freezed == acceptedTermsAt ? _self.acceptedTermsAt : acceptedTermsAt // ignore: cast_nullable_to_non_nullable
as DateTime?,deregistrationRequestedAt: freezed == deregistrationRequestedAt ? _self.deregistrationRequestedAt : deregistrationRequestedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,deregistrationEffectiveAt: freezed == deregistrationEffectiveAt ? _self.deregistrationEffectiveAt : deregistrationEffectiveAt // ignore: cast_nullable_to_non_nullable
as DateTime?,
  ));
}
/// Create a copy of MarketplaceProvider
...
// ── Seller registration fields ──
@override@JsonKey() Map<String, bool> get contactPreferences {
...
@override final  DateTime? deregistrationRequestedAt;
@override final  DateTime? deregistrationEffectiveAt;
