...
_GroupTransaction _$GroupTransactionFromJson(Map<String, dynamic> json) =>
    _GroupTransaction(
...
Map<String, dynamic> _$GroupTransactionToJson(_GroupTransaction instance) =>
    <String, dynamic>{
      'id': instance.id,
...
Map<String, dynamic> _$PendingApprovalToJson(
