...
mixin _$Cashout {
 ...
 String get id; String get walletId; String get userId; int get tokenAmount; double get zarAmount; CashoutMethod get method; CashoutStatus get status; String get destinationDetails; String? get bankName; String? get accountNumber; String? get accountHolderName; String? get mobileNumber; String? get reference; String? get failureReason; DateTime get createdAt; DateTime? get processedAt; DateTime? get completedAt; DateTime? get failedAt;
...
@useResult
$Res call({
 String id, String walletId, String userId, int tokenAmount, double zarAmount, CashoutMethod method, CashoutStatus status, String destinationDetails, String? bankName, String? accountNumber, String? accountHolderName, String? mobileNumber, String? reference, String? failureReason, DateTime createdAt, DateTime? processedAt, DateTime? completedAt, DateTime? failedAt
});
...
as CashoutMethod,status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as CashoutStatus,destinationDetails: null == destinationDetails ? _self.destinationDetails : destinationDetails // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String walletId,  String userId,  int tokenAmount,  double zarAmount,  CashoutMethod method,  CashoutStatus status,  String destinationDetails,  String? bankName,  String? accountNumber,  String? accountHolderName,  String? mobileNumber,  String? reference,  String? failureReason,  DateTime createdAt,  DateTime? processedAt,  DateTime? completedAt,  DateTime? failedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Cashout() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String walletId,  String userId,  int tokenAmount,  double zarAmount,  CashoutMethod method,  CashoutStatus status,  String destinationDetails,  String? bankName,  String? accountNumber,  String? accountHolderName,  String? mobileNumber,  String? reference,  String? failureReason,  DateTime createdAt,  DateTime? processedAt,  DateTime? completedAt,  DateTime? failedAt)  $default,) {final _that = this;
switch (_that) {
case _Cashout():
return $default(_that.id,_that.walletId,_that.userId,_that.tokenAmount,_that.zarAmount,_that.method,_that.status,_that.destinationDetails,_that.bankName,_that.accountNumber,_that.accountHolderName,_that.mobileNumber,_that.reference,_that.failureReason,_that.createdAt,_that.processedAt,_that.completedAt,_that.failedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String walletId,  String userId,  int tokenAmount,  double zarAmount,  CashoutMethod method,  CashoutStatus status,  String destinationDetails,  String? bankName,  String? accountNumber,  String? accountHolderName,  String? mobileNumber,  String? reference,  String? failureReason,  DateTime createdAt,  DateTime? processedAt,  DateTime? completedAt,  DateTime? failedAt)?  $default,) {final _that = this;
switch (_that) {
case _Cashout() when $default != null:
return $default(_that.id,_that.walletId,_that.userId,_that.tokenAmount,_that.zarAmount,_that.method,_that.status,_that.destinationDetails,_that.bankName,_that.accountNumber,_that.accountHolderName,_that.mobileNumber,_that.reference,_that.failureReason,_that.createdAt,_that.processedAt,_that.completedAt,_that.failedAt);case _:
  return null;
...
class _Cashout extends Cashout {
  const _Cashout({required this.id, required this.walletId, required this.userId, required this.tokenAmount, required this.zarAmount, required this.method, required this.status, required this.destinationDetails, this.bankName, this.accountNumber, this.accountHolderName, this.mobileNumber, this.reference, this.failureReason, required this.createdAt, this.processedAt, this.completedAt, this.failedAt}): super._();
...
@override final  CashoutMethod method;
@override final  CashoutStatus status;
