...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,buyerId,buyerName,sellerId,sellerName,listingId,listingTitle,amount,amountZar,status,escrowJournalId,releaseJournalId,refundJournalId,disputeReason,disputeResolution,chatConversationId,thumbnailUrl,createdAt,escrowedAt,fulfilledAt,completedAt,disputedAt,resolvedAt,cancelledAt,deliveryFee,totalAmount,deliveryMethod,deliveredVia,trackingInfo,deliveryDeadline,buyerConfirmationDeadline,refundType,disputeDetails,const DeepCollectionEquality().hash(disputePhotos),sellerDisputeResponse,const DeepCollectionEquality().hash(sellerDisputePhotos),sellerProposedResolution,disputeResolutionAmount,disputeResolutionNote,refundedAt]);
