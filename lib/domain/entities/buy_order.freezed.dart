...
abstract class $BuyOrderCopyWith<$Res> {
  factory $BuyOrderCopyWith(BuyOrder value, $Res Function(BuyOrder) then) =
      _$BuyOrderCopyWithImpl<$Res, BuyOrder>;
  @useResult
  $Res call({
    String id,
    String buyerId,
...
/// @nodoc
class _$BuyOrderCopyWithImpl<$Res, $Val extends BuyOrder>
...
/// @nodoc
abstract class _$$BuyOrderImplCopyWith<$Res>
    implements $BuyOrderCopyWith<$Res> {
  factory _$$BuyOrderImplCopyWith(
    _$BuyOrderImpl value,
    $Res Function(_$BuyOrderImpl) then,
  ) = __$$BuyOrderImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({
    String id,
...
/// @nodoc
class __$$BuyOrderImplCopyWithImpl<$Res>
    extends _$BuyOrderCopyWithImpl<$Res, _$BuyOrderImpl>
    implements _$$BuyOrderImplCopyWith<$Res> {
  __$$BuyOrderImplCopyWithImpl(
    _$BuyOrderImpl _value,
    $Res Function(_$BuyOrderImpl) _then,
  ) : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$BuyOrderImpl extends _BuyOrder {
  const _$BuyOrderImpl({
    required this.id,
  ...
  factory _$BuyOrderImpl.fromJson(Map<String, dynamic> json) =>
      _$$BuyOrderImplFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$BuyOrderImplCopyWith<_$BuyOrderImpl> get copyWith =>
      __$$BuyOrderImplCopyWithImpl<_$BuyOrderImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$BuyOrderImplToJson(this);
  }
}

abstract class _BuyOrder extends BuyOrder {
  ...
  const _BuyOrder._() : super._();

  factory _BuyOrder.fromJson(Map<String, dynamic> json) =
      _$BuyOrderImpl.fromJson;
