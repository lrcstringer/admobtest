...
mixin _$BuyOrder {
 ...
 int? get deliveryFee; int get totalAmount; String? get deliveryMethod; String? get deliveredVia; String? get trackingInfo; DateTime? get deliveryDeadline; DateTime? get buyerConfirmationDeadline; String? get refundType; String? get disputeDetails; List<String> get disputePhotos; String? get sellerDisputeResponse; List<String> get sellerDisputePhotos; String? get sellerProposedResolution; int? get disputeResolutionAmount; String? get disputeResolutionNote; DateTime? get refundedAt; int get version;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,buyerId,buyerName,sellerId,sellerName,listingId,listingTitle,amount,amountZar,status,escrowJournalId,releaseJournalId,refundJournalId,disputeReason,disputeResolution,chatConversationId,thumbnailUrl,createdAt,escrowedAt,fulfilledAt,completedAt,disputedAt,resolvedAt,cancelledAt,deliveryFee,totalAmount,deliveryMethod,deliveredVia,trackingInfo,deliveryDeadline,buyerConfirmationDeadline,refundType,disputeDetails,const DeepCollectionEquality().hash(disputePhotos),sellerDisputeResponse,const DeepCollectionEquality().hash(sellerDisputePhotos),sellerProposedResolution,disputeResolutionAmount,disputeResolutionNote,refundedAt,version]);

@override
String toString() {
  return 'BuyOrder(id: $id, buyerId: $buyerId, buyerName: $buyerName, sellerId: $sellerId, sellerName: $sellerName, listingId: $listingId, listingTitle: $listingTitle, amount: $amount, amountZar: $amountZar, status: $status, escrowJournalId: $escrowJournalId, releaseJournalId: $releaseJournalId, refundJournalId: $refundJournalId, disputeReason: $disputeReason, disputeResolution: $disputeResolution, chatConversationId: $chatConversationId, thumbnailUrl: $thumbnailUrl, createdAt: $createdAt, escrowedAt: $escrowedAt, fulfilledAt: $fulfilledAt, completedAt: $completedAt, disputedAt: $disputedAt, resolvedAt: $resolvedAt, cancelledAt: $cancelledAt, deliveryFee: $deliveryFee, totalAmount: $totalAmount, deliveryMethod: $deliveryMethod, deliveredVia: $deliveredVia, trackingInfo: $trackingInfo, deliveryDeadline: $deliveryDeadline, buyerConfirmationDeadline: $buyerConfirmationDeadline, refundType: $refundType, disputeDetails: $disputeDetails, disputePhotos: $disputePhotos, sellerDisputeResponse: $sellerDisputeResponse, sellerDisputePhotos: $sellerDisputePhotos, sellerProposedResolution: $sellerProposedResolution, disputeResolutionAmount: $disputeResolutionAmount, disputeResolutionNote: $disputeResolutionNote, refundedAt: $refundedAt, version: $version)';
}
...
as String?,deliveredVia: freezed == deliveredVia ? _self.deliveredVia : deliveredVia // ignore: cast_nullable_to_non_nullable
...
as String?,disputeDetails: freezed == disputeDetails ? _self.disputeDetails : disputeDetails // ignore: cast_nullable_to_non_nullable
as String?,disputePhotos: null == disputePhotos ? _self.disputePhotos : disputePhotos // ignore: cast_nullable_to_non_nullable
as List<String>,sellerDisputeResponse: freezed == sellerDisputeResponse ? _self.sellerDisputeResponse : sellerDisputeResponse // ignore: cast_nullable_to_non_nullable
...
class _BuyOrder extends BuyOrder {
  const _BuyOrder({required this.id, required this.buyerId, required this.buyerName, required this.sellerId, required this.sellerName, required this.listingId, required this.listingTitle, required this.amount, required this.amountZar, required this.status, this.escrowJournalId, this.releaseJournalId, this.refundJournalId, this.disputeReason, this.disputeResolution, this.chatConversationId, this.thumbnailUrl, required this.createdAt, this.escrowedAt, this.fulfilledAt, this.completedAt, this.disputedAt, this.resolvedAt, this.cancelledAt, this.deliveryFee, this.totalAmount = 0, this.deliveryMethod, this.deliveredVia, this.trackingInfo, this.deliveryDeadline, this.buyerConfirmationDeadline, this.refundType, this.disputeDetails, final  List<String> disputePhotos = const [], this.sellerDisputeResponse, final  List<String> sellerDisputePhotos = const [], this.sellerProposedResolution, this.disputeResolutionAmount, this.disputeResolutionNote, this.refundedAt, this.version = 0}): _disputePhotos = disputePhotos,_sellerDisputePhotos = sellerDisputePhotos,super._();
...
@override final  String? refundType;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,buyerId,buyerName,sellerId,sellerName,listingId,listingTitle,amount,amountZar,status,escrowJournalId,releaseJournalId,refundJournalId,disputeReason,disputeResolution,chatConversationId,thumbnailUrl,createdAt,escrowedAt,fulfilledAt,completedAt,disputedAt,resolvedAt,cancelledAt,deliveryFee,totalAmount,deliveryMethod,deliveredVia,trackingInfo,deliveryDeadline,buyerConfirmationDeadline,refundType,disputeDetails,const DeepCollectionEquality().hash(_disputePhotos),sellerDisputeResponse,const DeepCollectionEquality().hash(_sellerDisputePhotos),sellerProposedResolution,disputeResolutionAmount,disputeResolutionNote,refundedAt,version]);
