...
abstract class $CommunitySettingsCopyWith<$Res> {
  factory $CommunitySettingsCopyWith(
    ...
    $Res Function(CommunitySettings) then,
...
/// @nodoc
abstract class _$$CommunitySettingsImplCopyWith<$Res>
    implements $CommunitySettingsCopyWith<$Res> {
  factory _$$CommunitySettingsImplCopyWith(
    _$CommunitySettingsImpl value,
    $Res Function(_$CommunitySettingsImpl) then,
  ) = __$$CommunitySettingsImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({
    int maxMembers,
...
/// @nodoc
class __$$CommunitySettingsImplCopyWithImpl<$Res>
    extends _$CommunitySettingsCopyWithImpl<$Res, _$CommunitySettingsImpl>
    implements _$$CommunitySettingsImplCopyWith<$Res> {
  __$$CommunitySettingsImplCopyWithImpl(
    _$CommunitySettingsImpl _value,
    $Res Function(_$CommunitySettingsImpl) _then,
  ) : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$CommunitySettingsImpl extends _CommunitySettings {
  const _$CommunitySettingsImpl({
    this.maxMembers = 100,
  ...
  factory _$CommunitySettingsImpl.fromJson(Map<String, dynamic> json) =>
      _$$CommunitySettingsImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CommunitySettingsImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CommunitySettingsImplCopyWith<_$CommunitySettingsImpl> get copyWith =>
      __$$CommunitySettingsImplCopyWithImpl<_$CommunitySettingsImpl>(
        this,
        _$identity,
      );
  ...
  Map<String, dynamic> toJson() {
    return _$$CommunitySettingsImplToJson(this);
  }
}

abstract class _CommunitySettings extends CommunitySettings {
  ...
  const _CommunitySettings._() : super._();

  factory _CommunitySettings.fromJson(Map<String, dynamic> json) =
      _$CommunitySettingsImpl.fromJson;
...
mixin _$Community {
  ...
  CommunityType get type => throw _privateConstructorUsedError;
  String get name => throw _privateConstructorUsedError;
  String? get description => throw _privateConstructorUsedError;
  String? get avatarUrl =>
      throw _privateConstructorUsedError; // Ownership & membership
...
class _$CommunityCopyWithImpl<$Res, $Val extends Community>
  ...
  @pragma('vm:prefer-inline')
  $CommunitySettingsCopyWith<$Res> get settings {
    return $CommunitySettingsCopyWith<$Res>(_value.settings, (value) {
...
abstract class _Community extends Community {
  const factory _Community({
    ...
    required final CommunityType type,
  ...
  @override
  String? get avatarUrl; // Ownership & membership
  @override
  String get ownerId;
  @override
  List<String> get memberIds;
  ...
  @override
  StokvelSettings? get stokvelSettings; // Last message preview (for inbox list)
  @override
