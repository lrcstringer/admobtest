...
mixin _$RewardCampaign {
 ...
 String get id; String get clientId; String? get clientName; String? get clientAvatarImage; String? get clientAvatarColor; String get name; String? get description; RewardType get rewardType; CampaignStatus get status; int get totalQuantity; int get remainingQuantity; int get allocatedQuantity; int get redeemedQuantity; int get maxPerUser; DateTime get startsAt; DateTime get endsAt; DateTime? get itemExpiresAt; String? get displayImageUrl; int get displayPriority; Map<String, dynamic> get metadata; List<String> get linkedOpportunityIds; DateTime get createdAt;
/// Create a copy of RewardCampaign
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$RewardCampaignCopyWith<RewardCampaign> get copyWith => _$RewardCampaignCopyWithImpl<RewardCampaign>(this as RewardCampaign, _$identity);
...
/// @nodoc
abstract mixin class $RewardCampaignCopyWith<$Res>  {
  factory $RewardCampaignCopyWith(RewardCampaign value, $Res Function(RewardCampaign) _then) = _$RewardCampaignCopyWithImpl;
@useResult
$Res call({
 String id, String clientId, String? clientName, String? clientAvatarImage, String? clientAvatarColor, String name, String? description, RewardType rewardType, CampaignStatus status, int totalQuantity, int remainingQuantity, int allocatedQuantity, int redeemedQuantity, int maxPerUser, DateTime startsAt, DateTime endsAt, DateTime? itemExpiresAt, String? displayImageUrl, int displayPriority, Map<String, dynamic> metadata, List<String> linkedOpportunityIds, DateTime createdAt
});
...
/// @nodoc
class _$RewardCampaignCopyWithImpl<$Res>
    implements $RewardCampaignCopyWith<$Res> {
  _$RewardCampaignCopyWithImpl(this._self, this._then);

  final RewardCampaign _self;
  final $Res Function(RewardCampaign) _then;
...
as CampaignStatus,totalQuantity: null == totalQuantity ? _self.totalQuantity : totalQuantity // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [RewardCampaign].
extension RewardCampaignPatterns on RewardCampaign {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _RewardCampaign value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _RewardCampaign() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _RewardCampaign value)  $default,){
final _that = this;
switch (_that) {
case _RewardCampaign():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _RewardCampaign value)?  $default,){
final _that = this;
switch (_that) {
case _RewardCampaign() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$RewardCampaignCopyWith<_RewardCampaign> get copyWith => __$RewardCampaignCopyWithImpl<_RewardCampaign>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$RewardCampaignToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RewardCampaign&&(identical(other.id, id) || other.id == id)&&(identical(other.clientId, clientId) || other.clientId == clientId)&&(identical(other.clientName, clientName) || other.clientName == clientName)&&(identical(other.clientAvatarImage, clientAvatarImage) || other.clientAvatarImage == clientAvatarImage)&&(identical(other.clientAvatarColor, clientAvatarColor) || other.clientAvatarColor == clientAvatarColor)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.rewardType, rewardType) || other.rewardType == rewardType)&&(identical(other.status, status) || other.status == status)&&(identical(other.totalQuantity, totalQuantity) || other.totalQuantity == totalQuantity)&&(identical(other.remainingQuantity, remainingQuantity) || other.remainingQuantity == remainingQuantity)&&(identical(other.allocatedQuantity, allocatedQuantity) || other.allocatedQuantity == allocatedQuantity)&&(identical(other.redeemedQuantity, redeemedQuantity) || other.redeemedQuantity == redeemedQuantity)&&(identical(other.maxPerUser, maxPerUser) || other.maxPerUser == maxPerUser)&&(identical(other.startsAt, startsAt) || other.startsAt == startsAt)&&(identical(other.endsAt, endsAt) || other.endsAt == endsAt)&&(identical(other.itemExpiresAt, itemExpiresAt) || other.itemExpiresAt == itemExpiresAt)&&(identical(other.displayImageUrl, displayImageUrl) || other.displayImageUrl == displayImageUrl)&&(identical(other.displayPriority, displayPriority) || other.displayPriority == displayPriority)&&const DeepCollectionEquality().equals(other._metadata, _metadata)&&const DeepCollectionEquality().equals(other._linkedOpportunityIds, _linkedOpportunityIds)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}
...
/// @nodoc
abstract mixin class _$RewardCampaignCopyWith<$Res> implements $RewardCampaignCopyWith<$Res> {
  factory _$RewardCampaignCopyWith(_RewardCampaign value, $Res Function(_RewardCampaign) _then) = __$RewardCampaignCopyWithImpl;
@override @useResult
$Res call({
 String id, String clientId, String? clientName, String? clientAvatarImage, String? clientAvatarColor, String name, String? description, RewardType rewardType, CampaignStatus status, int totalQuantity, int remainingQuantity, int allocatedQuantity, int redeemedQuantity, int maxPerUser, DateTime startsAt, DateTime endsAt, DateTime? itemExpiresAt, String? displayImageUrl, int displayPriority, Map<String, dynamic> metadata, List<String> linkedOpportunityIds, DateTime createdAt
});
...
/// @nodoc
class __$RewardCampaignCopyWithImpl<$Res>
    implements _$RewardCampaignCopyWith<$Res> {
  __$RewardCampaignCopyWithImpl(this._self, this._then);

  final _RewardCampaign _self;
  final $Res Function(_RewardCampaign) _then;
