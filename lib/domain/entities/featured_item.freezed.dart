...
/// Only used when bgGradientType == 'custom'.
 ...
 String get imageLayout;/// Whether the title text is visible on the card.
 bool get showTitle; bool get isDeleted; DateTime? get createdAt; DateTime? get updatedAt;
...
switch (_that) {
case _FeaturedItem() when $default != null:
return $default(_that.id,_that.title,_that.subtitle,_that.imageUrl,_that.videoUrl,_that.type,_that.deepLinkRoute,_that.brandId,_that.communityIds,_that.isActive,_that.sortOrder,_that.scheduledStart,_that.scheduledEnd,_that.bgGradientType,_that.brandName,_that.ctaText,_that.bgColorHex,_that.colorIntensity,_that.imageOpacity,_that.imageLayout,_that.showTitle,_that.isDeleted,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
class _FeaturedItem extends FeaturedItem {
  const _FeaturedItem({required this.id, required this.title, this.subtitle, this.imageUrl, this.videoUrl, this.type = 'campaign', this.deepLinkRoute, this.brandId, final  List<String> communityIds = const [], this.isActive = true, this.sortOrder = 0, this.scheduledStart, this.scheduledEnd, this.bgGradientType = 'goldOrange', this.brandName, this.ctaText, this.bgColorHex, this.colorIntensity = 0.4, this.imageOpacity = 1.0, this.imageLayout = 'right', this.showTitle = true, this.isDeleted = false, this.createdAt = null, this.updatedAt = null}): _communityIds = communityIds,super._();
