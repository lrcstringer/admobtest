...
_GroupSettings _$GroupSettingsFromJson(Map<String, dynamic> json) =>
    _GroupSettings(
...
Map<String, dynamic> _$GroupSettingsToJson(
  _GroupSettings instance,
) => <String, dynamic>{
...
_StokvelSettings _$StokvelSettingsFromJson(Map<String, dynamic> json) =>
    _StokvelSettings(
...
Map<String, dynamic> _$StokvelSettingsToJson(_StokvelSettings instance) =>
    <String, dynamic>{
