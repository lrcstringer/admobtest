...
_PoolContribution _$PoolContributionFromJson(Map<String, dynamic> json) =>
    _PoolContribution(
...
Map<String, dynamic> _$PoolContributionToJson(_PoolContribution instance) =>
    <String, dynamic>{
...
_PoolPayout _$PoolPayoutFromJson(Map<String, dynamic> json) => _PoolPayout(
  userId: json['userId'] as String,
  displayName: json['displayName'] as String,
  amount: (json['amount'] as num).toInt(),
);

Map<String, dynamic> _$PoolPayoutToJson(_PoolPayout instance) =>
    <String, dynamic>{
      'userId': instance.userId,
      'displayName': instance.displayName,
...
_TokenPool _$TokenPoolFromJson(Map<String, dynamic> json) => _TokenPool(
  ...
  contributions:
      (json['contributions'] as Map<String, dynamic>?)?.map(
        (k, e) =>
            MapEntry(k, PoolContribution.fromJson(e as Map<String, dynamic>)),
      ) ??
      const {},
  payouts:
...
Map<String, dynamic> _$TokenPoolToJson(_TokenPool instance) =>
    <String, dynamic>{
      'id': instance.id,
