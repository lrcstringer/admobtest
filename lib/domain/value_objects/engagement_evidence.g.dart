...
_UploadedFileEvidence _$UploadedFileEvidenceFromJson(
...
Map<String, dynamic> _$UploadedFileEvidenceToJson(
  _UploadedFileEvidence instance,
) => <String, dynamic>{
  'url': instance.url,
  'type': instance.type,
...
_EngagementEvidence _$EngagementEvidenceFromJson(Map<String, dynamic> json) =>
    _EngagementEvidence(
...
Map<String, dynamic> _$EngagementEvidenceToJson(_EngagementEvidence instance) =>
    <String, dynamic>{
